...
if __name__ == "__main__":
    ...
    with cont2:
        ...
        with st.container(border=True, height=650):
            ...
            st.markdown("<h2 style='text-align: center;'>Subscribe for alerts &#x1F514;</h2>",
                        unsafe_allow_html=True)
            st.markdown(
                """<p style='text-align: center;
                '>Enter your details below to receive
                live alerts and updates for service disruptions.</p>""", unsafe_allow_html=True)
            ...
            with col2:
                ...
                selected_operators = st.multiselect(
                    'Select Train Operator/s: ', options=OPERATORS.values(), label_visibility='collapsed')
                st.write("")
                ...
                if phone_checkbox:
                    ...
                    st.text_input(
                        "Enter mobile number", disabled=True)
                    phone_number = None

                st.write("")

                st.button("Submit Form", key="submit_button",
                          on_click=lambda: on_submit(sns, TOPIC, selected_operators,
                                                     email, phone_number))
